...
//		},
	...
	var reportScore = sequelize.define("reportScore",{
		rs_id: {
			type: DataTypes.INTEGER, autoIncrement: true,
			primaryKey: true,
			field: 'RS_ID'
	...
	var dimensionScore = sequelize.define("dimensionScore",{
		ds_id: {
			type: DataTypes.INTEGER, autoIncrement: true,
			primaryKey: true,
			field: 'DS_ID'
	...
	var metricScore = sequelize.define("metricScore",{
		ms_id: {
			type: DataTypes.INTEGER, autoIncrement: true,
			primaryKey: true,
			field: 'MS_ID'
	...
	return [report,dimension,metric,metricScore, dimensionScore, reportScore];
};